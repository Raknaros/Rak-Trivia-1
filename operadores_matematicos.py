...
print("Ahora, la pregunta 3.\n")
print("¿Quién fue Hittler?\n")
print ("a) Un político aleman fundador del partido Nazi")
print ("b) Un loco genocida que odiaba a los Judíos")
print ("c) El señor del bigote gracioso de las películas")
print ("d) Uhmm no lo conozco\n")
respuesta_3 = input()
if respuesta_3 == "a":
  puntos += 5
  print("Una respuesta válida, obtuviste 5 puntos y ahora tienes ", puntos,"puntos.")
elif respuesta_3 == "b":
  puntos *= 2
  print("Una respuesta más firme, tomando en cuenta las atrocidades que cometio. Tus puntos se duplicaron y tienes ", puntos,"puntos.")
elif respuesta_3 == "c":
  puntos -= 4
  print("Jaja, casi lo logras pero no es la respuesta correcta, tienes 3 puntos menos y te quedas con ", puntos,"puntos.")
else:
  puntos /= 2
  print("¿No sabes quién es? Pierdes la mitad de tus puntos, es importante conocer la historia para evitar repetirla.\nTe quedas solo con ", puntos,"puntos.")